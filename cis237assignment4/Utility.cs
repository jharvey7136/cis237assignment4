...
namespace cis237assignment4
{
    class Utility : Droid
    {
        ...
        {
            return this.Material.PadRight(8) + this.Model.PadRight(15) + this.Color.PadRight(9) + toolBoxYesNo.PadRight(18) + computerConnectionYesNo.PadRight(28) + armYesNo.PadRight(55) + " $" + costString.PadLeft(5);
        }
